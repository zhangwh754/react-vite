...
import { SurveyRadioProps } from './interface'
import { DeleteOutlined, PlusOutlined } from '@ant-design/icons'

const { Paragraph } = Typography

const PropView: FC<SurveyRadioProps> = prop => {
  ...
  const onAllFieldChange = () => {
    if (onChange) {
      const values = form.getFieldsValue() as SurveyRadioProps
                      ...
                      rules={[
                        {
                          validator(_, text: string) {
                            const { options = [] } = form.getFieldsValue() as SurveyRadioProps
